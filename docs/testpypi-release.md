...
```bash
git tag testpypi-v0.4.5rc1
git push origin testpypi-v0.4.5rc1
```
...
```bash
python -m venv /tmp/vasp-lsp-testpypi
/tmp/vasp-lsp-testpypi/bin/python -m pip install --upgrade pip
/tmp/vasp-lsp-testpypi/bin/pip install \
